	...
	<div class="container">
		...
		<div class="row">
			...
			<div class="col-md-8">
				...
				<hr>
				<p class="text-justify" style="text-indent: 50px;"><span>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Aperiam, quos. At placeat dolorem, recusandae cum dicta laudantium repellat consequatur facilis quidem esse consequuntur reprehenderit expedita accusamus ipsum nisi, odit, accusantium.</span>
